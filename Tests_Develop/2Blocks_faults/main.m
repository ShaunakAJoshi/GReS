...
coordSlave1 = solverStandard.models(2).Grid.topology.coordinates(solverStandard.mortar.idSlave,:);
coordSlave2 = solverStandard.models(2).Grid.topology.coordinates;
