...
writeBCfiles('BCs/rightLatLoad','SurfBC','Neu','Poro',"x",'right_latLoad',[0 1 7 11 16],[0 -5 -5 0 0],rightMesh,2); % right block bottom fix
writeBCfiles('BCs/rightTopLoad','SurfBC','Neu','Poro',"z",'right_topLoad',[0 1 7 11 16],[0 0 -18 -18 0],rightMesh,3); % right block bottom fix
